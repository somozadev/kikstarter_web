      ...
      <div class="row justify-content-center justify-content-md-start">
        <div class="col-10 col-md-6 static">
          <div class="owl-slide-text">
            ...
            <a class="btn btn-primary owl-slide-cta" href="Rolls-Royce_Vision_100.php" role="button">Ver más información</a>
            <!--target="_blank" -->
          </div>
        </div>
      </div>
      ...
      <div class="row justify-content-center justify-content-md-start">
        <div class="col-10 col-md-6 static">
          <div class="owl-slide-text">
            ...
            <a class="btn btn-primary owl-slide-cta" href="Vision_Next_100_de_BMW.php" role="button">Ver más información</a>
            <!--target="_blank" -->
          </div>
        </div>
      </div>
      ...
      <div class="row justify-content-center justify-content-md-start">
        <div class="col-10 col-md-6 static">
          <div class="owl-slide-text">
            ...
            <a class="btn btn-primary owl-slide-cta" href="Mini_Vision_Next_100.php" role="button">Ver más información</a>
            <!--target="_blank" -->
          </div>
        </div>
      </div>
